...
#        print self.dataset
        ...
        '''
        populate list in the iterating variable trial_set 
        '''
        #count=0
...
dataset=[(('sunny','warm','normal','strong','warm','same'),'Y'),(('sunny','warm','high','strong','warm','same'),'Y'),(('rainy','cold','high','strong','warm','change'),'N'),(('sunny','warm','high','strong','cool','change'),'Y')] # tuple to list
attributes =('Sky','Temp','Humidity','Wind','Water','Forecast') # tuple
